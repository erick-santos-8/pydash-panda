...
class R2APANDA(IR2A):
    ...
    def handle_xml_request(self, msg):
        ...
        self.tempo_ultima_solicitacao = time.perf_counter() # used to calculate the first throughput
        self.send_down(msg)
    ...
    def handle_xml_response(self, msg):
        ...
        self.xtn_m1 = msg.get_bit_length() / (time.perf_counter() - self.tempo_ultima_solicitacao)
    ...
    def handle_segment_size_request(self, msg):
        ...
        tempo_de_espera = time.perf_counter() - self.tempo_ultima_solicitacao
        ...
        solicitação_de_tempo_atual = time.perf_counter()
        ...
        # Estimativa  
        xcn = (self.k * (self.w - (self.xcn_m1 - self.xtn_m1 + self.w))) * intervalo_tempo_solicitacao_atual + xcn_m1
